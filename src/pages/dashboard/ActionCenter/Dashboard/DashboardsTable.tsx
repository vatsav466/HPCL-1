...
import { ChevronDown, ChevronRight, Star, Search, Edit, Trash2, SearchIcon } from 'lucide-react';
import { Dialog, DialogTitle, DialogContent, DialogContentText, DialogActions, Snackbar, Alert, Tooltip } from '@mui/material';
